...
class ControladorFuncionarios:
    ...
    def incluir_funcionario(self):
        ...
        if isinstance(self.pega_funcionario_por_cpf(dados_funcionario["cpf"]), Funcionario):
            self.__tela_funcionario.mostra_mensagem("Este funcionário já foi cadastrado")
            return False
    ...
    def excluir_funcionario(self):
        ...
        funcionario = self.pega_funcionario_por_cpf(cpf_funcionario)
        if isinstance(funcionario, Funcionario):
            self.__tela_funcionario.mostra_mensagem(f"Funcionário {funcionario.nome} excluído.\n")
